...
public class MatGeneratorController implements Initializable {
    ...
    private final Label matNameL = new Label ("Material Name");
    ...
    private final Label selMat = new Label ("Select Element");
    private final Button selMe = new Button ("Select");
    private final Button delMe = new Button ("Delete");
    private final Button clsMe = new Button ("Clear");
    private final Button acceptMe = new Button ("Accept");
    ...
    public void selMat() {
        ...
        selMat.setFont (new Font ("System Bold", 17));
        selMat.setTextFill (Color.web ("#125e7c"));
        materials.getItems ().clear ();
        materials.setMaxWidth (240);
        materials.setMaxHeight (130);
        materials.setLayoutX (30);
        materials.setLayoutY (90);
        materials.setItems (elementName);        
        selMe.setLayoutX (120);
        selMe.setLayoutY (250);
        selMe.setFont (new Font ("System Bold", 11));
        selMe.setTextFill (Color.web ("#125e7c"));       
        matSelected.getItems ().clear ();
        matSelected.setMaxWidth (240);
        matSelected.setMaxHeight (130);
        matSelected.setLayoutX (300);
        matSelected.setLayoutY (90);

        clsMe.setLayoutX (300);
        clsMe.setLayoutY (250);
        clsMe.setFont (new Font ("System Bold", 11));
        clsMe.setTextFill (Color.web ("#125e7c"));
        delMe.setLayoutX (390);
        delMe.setLayoutY (250);
        delMe.setFont (new Font ("System Bold", 11));
        delMe.setTextFill (Color.web ("#125e7c"));
        acceptMe.setLayoutX (480);
        acceptMe.setLayoutY (250);
        acceptMe.setFont (new Font ("System Bold", 11));
        acceptMe.setTextFill (Color.web ("#125e7c"));
        ...
        acceptMe.addEventHandler (MouseEvent.MOUSE_CLICKED, evt -> {
            ...
            for ( int ii = 0; ii < count; ii++ ) {
                ...
                int dataArray2Search
                        = (Integer) datType.get (tempList.get (ii)).intValue ();
                int srNum = (Integer) serialNum.get (tempList.get (ii)).
                        intValue ();
