...
>>>>>>> f4075c2159eec1ac404a9931593676b5782a9ea3
    ...
    private void doCopy(ActionEvent event) {
        ...
        try2Copy();
        popupMsg.infoBox("Copy operation selected which is under development. Please have patience. Thank You", " Feature under development");
    }
    ...
    private void doMirror(ActionEvent event) {
        ...
        popupMsg.infoBox("Mirror operation selected which is under developemtn. Please have patience. Thank You", "feature under development");
    }
}
