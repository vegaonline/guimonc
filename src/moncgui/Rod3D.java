...
public class Rod3D extends Group {
    ...
    public Rod3D(double P1X, double P1Y, double P1Z, double P2X, double P2Y,
            double P2Z, Color color) {
    ...
    public Rod3D(Vector3D P1, Vector3D P2, Color color, double thick) {
        ...
        Vector3D edge1 = new Vector3D ((P2.getX () - P1.getX ()) / size, (P2.
                getY () - P1.getY ()) / size, (P2.getZ () - P1.getZ ()) / size);
        ...
        if ( Vector3D.vectorLength (rotAxis) < 1E-6 ) {
...
//        	getTransforms().add(new Translate(P1.getX(), P1.getY(), 0));
        getTransforms ().
                add (new Translate (P1.getX (), P1.getY (), P1.getZ ()));
...
//        	getTransforms().add(new Rotate(sign*thetaDeg,0,0,0,Rotate.Z_AXIS));
        getTransforms ().add (new Rotate (thetaDeg, 0, 0, 0, rotAxis.
                toPoint3D ()));
...
//System.out.println("3SCALE Z=" +  	cube.getScaleZ());
    ...
    public String toString() {
        ...
        return "minX=" + b.getMinX () + " minY=" + b.getMinY () + " minZ=" + b.
                getMinZ () + "  maxX=" + b.getMaxX () + " maxY=" + b.getMaxY () +
                " maxZ=" + b.getMaxZ ();
    }
}
